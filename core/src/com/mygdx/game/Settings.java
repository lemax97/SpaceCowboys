            ...
            public void handleHttpResponse(Net.HttpResponse httpResponse){
                ...
                if (scores.length > 0)
                    for (int i = 0; i < scores.length; i++) {
                        ...
                        if (i == 0) leaderboardItems[i]
                                .setText(String.valueOf(Integer.valueOf(score[score.length - 1]) + 1)
                                        + ")" + score[0] + ": " + score[1]);
                        else leaderboardItems[i] = new
                                Label(String.valueOf(Integer.valueOf(score[score.length - 1]) + 1)
